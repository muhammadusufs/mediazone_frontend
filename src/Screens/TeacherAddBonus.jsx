...
const TeacherAddBonus = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setProgress(35);
      const resp = await TeacherService.add_bonus(teacher_id, amount, comment);
      if (resp === 201) {
        handleMessage("success", "Bonus qo'shildi");
        setTimeout(() => {
          ...
          <Grid container spacing={3}>
            <Grid item xs={12} sm={12} md={6}>
              <TextField
                ...
                label="Bonus miqdori"
                fullWidth
                helperText={"Berilgan bonus miqdori"}
              />
            </Grid>
            <Grid item xs={12} sm={12} md={6}>
              <TextField
...
export default TeacherAddBonus;
